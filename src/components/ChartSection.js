  ...
  return (
    <div className="px-[59px] mt-12 relative max-h-[430px]">
      ...
      <div className="absolute top-0 z-20 left-[59px] right-[59px] bottom-0 p-5 flex flex-col gap-8">
        <Link
          to={path.ZING_CHART}
          className="flex items-center gap-2 text-white hover:text-green-700"
        >
        ...
        <div className="flex h-full gap-4">
          <div className="flex flex-col gap-4 flex-3">
            ...
            <Link
              to={path.ZING_CHART}
              className="px-4 py-2 m-auto text-white border border-white rounded-l-full rounded-r-full w-fit hover:bg-[hsla(0,0%,100%,.07)]  "
            >
              Xem thêm
            </Link>
          </div>
